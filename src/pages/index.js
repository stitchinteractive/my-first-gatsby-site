						...
						<div class="col-lg-8">
							<div class="row gx-5 row-cols-1 row-cols-md-2">
								<div class="col mb-5 h-100">
									...
									<p class="mb-0">
										Paragraph of text beneath the heading to explain the heading. Here is just a bit
										more text.
									</p>
								</div>
								<div class="col mb-5 h-100">
						...
						<div class="col-lg-10 col-xl-7">
							<div class="text-center">
								<div class="fs-4 mb-4 fst-italic">
									...
									building new projects! Starting with a Bootstrap template just makes things easier!"
								</div>
						...
						<div class="col-lg-4 mb-5">
							<div class="card h-100 shadow border-0">
								...
								<div class="card-body p-4">
									...
									<p class="card-text mb-0">
										This text is a bit longer to illustrate the adaptive height of each card. Some
						...
						<div class="col-lg-4 mb-5">
							<div class="card h-100 shadow border-0">
								...
								<div class="card-body p-4">
									...
									<p class="card-text mb-0">
										Some more quick example text to build on the card title and make up the bulk of
										the card's content.
									</p>
								</div>
								<div class="card-footer p-4 pt-0 bg-transparent border-top-0">
